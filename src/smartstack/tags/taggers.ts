...
export const tagAccount: Tagger = (
  _: Construct,
  tags: Tags,
  values: Values,
) => {
...
export const tagEnvironment: Tagger = (
  scope: Construct,
  tags: Tags,
  values: Values,
) => {
...
export const tagProject: Tagger = (
  scope: Construct,
  tags: Tags,
  values: Values,
) => {
...
export const tagAuthorName: Tagger = (
  _: Construct,
  tags: Tags,
  values: Values,
) => {
...
export const tagAuthorOrganization: Tagger = (
  scope: Construct,
  tags: Tags,
  values: Values,
) => {
...
export const tagAuthorEmail: Tagger = (
  scope: Construct,
  tags: Tags,
  values: Values,
) => {
